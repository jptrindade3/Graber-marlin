...
#define STRING_CONFIG_H_AUTHOR "(jptrindade3, Grab-v1.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Zarathustra"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 53, 100, -06.43 }
