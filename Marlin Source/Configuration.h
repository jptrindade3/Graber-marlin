...
#define STRING_CONFIG_H_AUTHOR "(3DCore Consultoria em impressao 3d, Ricardo Pimenta, 42/12/2018, v1.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3D Core"
...
#define POWER_SUPPLY 1
  ...
  //#define AUTOWER_CONTROL_PO        // Enable automatic control of the PS_ON pin
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define DEFAULT_Kd 64.29
  

// FIND YOUR OWN: "M303 E0 S220 C8" to run autotune on the nozzle for 8 cycles.
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 361.68
  #define DEFAULT_bedKi 67.92
  #define DEFAULT_bedKd 481.49
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 288.88 } 
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 100  // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER -06.43   // Z offset: -below +above  [the nozzle]
